  ...
  bestDeals: function() {
  	...
  	Game.tooltip.draw(this, function () {
  		...
  		CookieCruncher.buildings.forEach(building => {
  			...
  			'<div class="prices">'+
  				'<small>+</small>' + Math.round(((building.value/CookieCruncher.buildings[0].value)-1)*100) + '%<br>'+
  				'<small>'+
  					'<span class="price '+(building.canBuy?'':'disabled')+'" style="padding-top:3px">'+building.price+'</span>'+
  				'</small>'+
  			'</div>'+
